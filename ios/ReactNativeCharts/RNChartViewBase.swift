    ...
    func setCommonAxisConfig(_ axis: AxisBase, config: JSON) {
        ...
        if valueFormatter.array != nil {
            ...
            if "largeValue" == valueFormatter.stringValue {
              ...
              if (valueFormatterPattern == "" && chart is BarLineChartViewBase) {
                  axis.valueFormatter = BarLineChartDateFormatter(chart: chart as! BarLineChartViewBase, timeUnit: timeUnit);
              } else {
